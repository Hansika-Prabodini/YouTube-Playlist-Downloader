...
class YouTubeDownloaderApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.path_label = ctk.CTkLabel(path_frame, text=f"Download Path: {self.download_path}", font=("Arial", 10), text_color="gray")
        ...
        self.status_label = ctk.CTkLabel(self, text="Enter a playlist URL and click 'Load Playlist'.", font=("Arial", 12))
        ...
        self.footer_label = ctk.CTkLabel(self, text="© 2025 Nuwan Kaushalya", text_color="gray")
    ...
    def create_context_menu(self):
        ...
        self.context_menu.add_command(label="Cut", command=lambda: self.url_entry.event_generate("<<Cut>>"), state=tk.NORMAL)
        self.context_menu.add_command(label="Copy", command=lambda: self.url_entry.event_generate("<<Copy>>"), state=tk.NORMAL)
        self.context_menu.add_command(label="Paste", command=self.paste_from_clipboard, state=tk.NORMAL)
    ...
    def start_fetch_thread(self):
        ...
        self.status_label.configure(text="Fetching playlist titles, please wait...")
    ...
    def display_videos(self):
        ...
        if self.video_info_list:
            ...
            self.status_label.configure(text="No videos were found in the playlist.")
    ...
    def run_download(self, video_url):
        ...
        try:
            ...
            if is_success:
                self.after(0, lambda: widgets['status_label'].configure(text="Download completed successfully!"))
    ...
    def cancel_single_download(self, video_url):
        ...
        if video_url in self.download_processes:
            ...
            widgets = self.video_widgets[video_url]
            self.after(0, lambda: widgets['status_label'].configure(text="Cancelling download...")) # Immediate feedback
